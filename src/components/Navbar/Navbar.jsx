                ...
                sm:text-3xl'
                                        ...
                                        <ul className='space-y-2'>
                                            {
                                                DropdownLinks.map((data, index) => (
                                                    <li key={index}>
                                                        ...
                                                        w-full hover:bg-primary/20 rounded-md font-semibold'
                                                            href={data.link}
                                                        >
                                                            {data.name} </a>
                                                    </li>
                    ...
                    <div className='flex justify-between items-center gap-4'>
                        ...
                        <div className='relative group hidden sm:block'>
                            ...
                            />
                            <IoMdSearch className="text-xl group-hover:text-primary text-gray-600 
...
//         dark:text-white duration relative z-40'
//         >
//             <div className='py-4'>
...
//                                         <li key={index}>
//                                             <a href={data.link}
//                                                 className='inline-block px-1 font-semibold
//                                             text-gray-500
//                                             hover:text-black
//                                             dark:hover:text-white duration-200'
//                                             >
